...
public class UploadFileService extends IntentService {
    ...
    public UploadFileService(String url, Context context) {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Toast.makeText(getBaseContext(),"upload file process started",Toast.LENGTH_LONG).show();
        ...
        client.post(context,"http://www.scholarnetapp.com/mob/setPost/",params, new TextHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, String responseString) {
                ...
                Toast.makeText(UploadFileService.this, "article upload process is " + responseString + "!!", Toast.LENGTH_LONG).show();
            }

            @Override
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {

                Toast.makeText(UploadFileService.this, "upload failed", Toast.LENGTH_LONG).show();
                Toast.makeText(UploadFileService.this, new String(throwable.toString()), Toast.LENGTH_LONG).show();
